...
class Buyer(Page):
    ...
    def vars_for_template(self):
        return {"pdf_file": "SugarBowl_Section2/Buyer.pdf"}
...
class Dealer(Page):
    ...
    def vars_for_template(self):
        return {"pdf_file": "SugarBowl_Section2/Dealer.pdf"}
...
class Journaling_page(Page):
    ...
    def vars_for_template(self):
        return {"Buyer": "SugarBowl_Section2/Buyer.pdf", "Dealer": "SugarBowl_Section2/Dealer.pdf"}
